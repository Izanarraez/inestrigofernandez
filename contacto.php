...
<body>
    ...
    <section class="container-fluid bg-buzon">
        ...
        <div class="row justify-content-between bg-buzonR">
            ...
            <div class="col-12 col-md-6 mt-4 d-flex justify-content-end flex-wrap"> <!--<div class="col-12 col-md-4 mt-4 d-flex justify-content-center flex-wrap bg-chicaC">-->
            ...
            <div class="col-12 col-md-6 mt-4 d-flex justify-content-center flex-wrap"> <!--<div class="col-12 col-md-4 mt-4 d-flex justify-content-center flex-wrap bg-chicaLl">-->
            ...
            <!--<div class="col-12 col-md-4 mt-4 d-flex justify-content-center flex-wrap bg-chicaH">
